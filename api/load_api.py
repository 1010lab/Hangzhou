...
class LoadApi(Resource):
    ...
    def post(self):
        ...
        parse.add_argument("dataPath",type=str,default=r"NEO4J_data_import/data",help="neo4j目录不能为空")
        parse.add_argument("neo4jDataPath",type=str,default=r"NEO4J_data_import/neo4j_data",help="neo4j目录不能为空")
